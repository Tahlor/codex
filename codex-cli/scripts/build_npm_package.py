#!/usr/bin/env python3
"""Stage and optionally package the codexx npm module."""
...
CODEX_NPM_NAME = "codexx"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying platform payload package is published with a suffixed version.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "codexx-linux-x64",
        "npm_tag": "linux-x64",
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        for launcher in ("codex.js", "codex-v5.js", "codex-v6.js"):
