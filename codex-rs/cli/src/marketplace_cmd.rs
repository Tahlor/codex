...
#[derive(Debug, Parser)]
#[command(bin_name = "codexx plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codexx plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codexx plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "codexx plugin marketplace remove")]
